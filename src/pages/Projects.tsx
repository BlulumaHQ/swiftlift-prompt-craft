...
import { ArrowLeft, Copy, Check, Files, X } from 'lucide-react';
      ...
      <div className="flex flex-col h-screen">
        <header className="console-header flex items-center justify-between px-6 py-3 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-sm font-semibold tracking-tight text-[hsl(var(--console-header-foreground))]">Projects</h1>
          </div>
          <Link to="/" className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium bg-[hsl(var(--console-header-foreground)/0.1)] text-[hsl(var(--console-header-foreground))] hover:bg-[hsl(var(--console-header-foreground)/0.15)] transition-colors">
            Console
          </Link>
        </header>
        <div className="flex-1 overflow-y-auto p-6 max-w-5xl mx-auto w-full">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">{selected.sourceUrl} · {selected.packageTier} Structure · {selected.dateCreated}</p>
          </div>
